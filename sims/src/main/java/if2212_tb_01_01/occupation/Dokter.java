...
public class Dokter implements Pekerjaan {
    private String namaPekerjaan;
    private String deskripsiPekerjaan;
    private Integer gaji = 50;
    private Integer daysWorked;

    public Dokter(String namaPekerjaan, String deskripsiPekerjaan, Integer gaji, Integer daysWorked) {
